function [means,idx,ClusterMeans, fig1,fig2, fig3, fig4, fig5]  = SPIFEE_Single(data,feats,hours, lenPulse)
...
title(fig3,"Optimal Number of Clusters for Different Criteria")
colors = lines(4);
